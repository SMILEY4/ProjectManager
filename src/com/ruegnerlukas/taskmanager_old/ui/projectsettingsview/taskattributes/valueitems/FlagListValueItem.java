...
import com.ruegnerlukas.taskmanager.ui.projectsettingsview.taskattributes.valueitems.FlagValueItem;
...
public abstract class FlagListValueItem extends AttributeValueItem {
	...
	private List<com.ruegnerlukas.taskmanager.ui.projectsettingsview.taskattributes.valueitems.FlagValueItem> flagItems = new ArrayList<>();
	...
	private void createNewFlag() {
		...
		com.ruegnerlukas.taskmanager.ui.projectsettingsview.taskattributes.valueitems.FlagValueItem item = new com.ruegnerlukas.taskmanager.ui.projectsettingsview.taskattributes.valueitems.FlagValueItem(flag) {
	...
	private void removeFlagItem(com.ruegnerlukas.taskmanager.ui.projectsettingsview.taskattributes.valueitems.FlagValueItem item) {
	...
	private void moveItemUp(com.ruegnerlukas.taskmanager.ui.projectsettingsview.taskattributes.valueitems.FlagValueItem item) {
	...
	private void moveItemDown(com.ruegnerlukas.taskmanager.ui.projectsettingsview.taskattributes.valueitems.FlagValueItem item) {
	...
	public void unlockFlag(TaskFlag flag) {
		for (com.ruegnerlukas.taskmanager.ui.projectsettingsview.taskattributes.valueitems.FlagValueItem item : flagItems) {
