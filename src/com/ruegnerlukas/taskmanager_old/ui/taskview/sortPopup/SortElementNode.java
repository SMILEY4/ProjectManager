...
public class SortElementNode extends HBox {
	...
	private com.ruegnerlukas.taskmanager.ui.taskview.sortPopup.SortPopup parent;
	...
	public SortElementNode(TaskAttribute attribute, com.ruegnerlukas.taskmanager.ui.taskview.sortPopup.SortPopup parent) {
