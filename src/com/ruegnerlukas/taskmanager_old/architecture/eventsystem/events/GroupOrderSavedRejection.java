...
public class GroupOrderSavedRejection extends Event {
	...
	public GroupOrderSavedRejection(String name, List<TaskAttribute> elements, com.ruegnerlukas.taskmanager.architecture.eventsystem.events.EventCause cause, Object source) {
		super(source);
		this.name = name;
