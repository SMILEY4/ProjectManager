...
public class ActionSettingsName extends FileAction {


	public ActionSettingsName(FileHandler fileHandler) {
		super(fileHandler);
	}
	...
	public void onChange(DataChange change) {
		...
		if (!(valueChange.getNewValue() instanceof String)) {
			return;
		}
		...
		try {
			...
			// modify
			data.projectName = (String) valueChange.getNewValue();
